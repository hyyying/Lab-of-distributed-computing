...
<%--    显示所有符合条件的机票--%>
    <div class="modal fade" id="" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <c:set var="openModal_AddNewWork" value="0" scope="session"/>
                <form action="" method="post" class="form-horizontal" role="form">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel1">添加题目</h4>
                    </div>
                    <table class="table table-striped" id="coursetable">
                        ...
                        <tbody>
                        <c:forEach var="i" items="${sessionScope.q_list}" varStatus="status2">
                            <tr>
                                <td>简答题</td>
                                <td>${i.getText()}</td>
                                <td>${i.getAnswer()}</td>
                                <td><a class="btn btn-info" href="javascript:addScore(${i.getId()})">添加</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
